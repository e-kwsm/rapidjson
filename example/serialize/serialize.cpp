...
public:
    Dependent(const std::string& name, unsigned age, Education* education = nullptr) : Person(name, age), education_(education) {}
    Dependent(const Dependent& rhs) : Person(rhs), education_(nullptr) { education_ = (rhs.education_ == nullptr) ? nullptr : new Education(*rhs.education_); }
    virtual ~Dependent();
    ...
    Dependent& operator=(const Dependent& rhs) {
        if (this == &rhs)
            return *this;
        delete education_;
        education_ = (rhs.education_ == nullptr) ? nullptr : new Education(*rhs.education_);
        return *this;
    }
